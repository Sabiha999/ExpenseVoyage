...
<!-- Mirrored from themesflat.co/html/vitour/home4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 10:15:29 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="app/css/textanimation.css">
                        ...
                        <div class="row ">
                            <div class="col-10 col-xl-7">
                                <div class="home4-content z-index3">
                                    ...
                                    <div class="btn-group">
                                        <a href="archive-tour.php" class="btn-main wow fadeInUp animated">
                                            <p class="btn-main-text">Let,s get started</p>
                                            <p class="iconer">
                                                <i class="icon-arrow-right"></i>
                                            </p>
                                        </a>
                                        <a href="destination,php" class="btn-w-wa text-main wow fadeInUp animated">Beautiful Places
                                            Arround the World.</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-2 col-xl-5 relative">
                                <div class="video-wrap">
                                    <a href="https://www.youtube.com/watch?v=HFWgThplaLw"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 inner-content-about">
                                ...
                                <div class="flex-three btn-wrap-about  mb-30 ">
                                    <a href="about.php" class="btn-main wow fadeInUp animated">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-widget-populer">
                                                ...
                                                <div class="content relative center">
                                                    ...
                                                    <h5 class="title-populer mb-18"><a href="destination.php">Switzerland</a></h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-widget-populer">
                                                ...
                                                <div class="content relative center">
                                                    ...
                                                    <h5 class="title-populer mb-18"><a href="destination.php">United Kingdom</a></h5>
                                                    <p class="des-populer">Welcome to our Print 128 website company that
                                                        offers</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-widget-populer">
                                                ...
                                                <div class="content relative center">
                                                    ...
                                                    <h5 class="title-populer mb-18"><a href="destination.php">Thailand</a></h5>
                                                    <p class="des-populer">Welcome to our Print 128 website company that
                                                        offers</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-widget-populer">
                                                ...
                                                <div class="content relative center">
                                                    ...
                                                    <h5 class="title-populer mb-18"><a href="destination.php">Srilanka</a>
                                                    </h5>
                                                    <p class="des-populer">Welcome to our Print 128 website company that
                                                        offers</p>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-widget-populer">
                                                ...
                                                <div class="content relative center">
                                                    ...
                                                    <h5 class="title-populer mb-18"><a href="destination.php">Singapore</a></h5>
                                                    <p class="des-populer">Welcome to our Print 128 website company that
                                                        offers</p>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-2 wow fadeInUp animated " data-wow-delay="0.1s">
                                <div class="tf-image-box center">
                                    <a href="tour.php" class="image">
                                        <img src="assets/images/tour/tour4-1.jpg" alt="Image">
                                    </a>
                                    <h6><a href="tour.php">Switzerland</a></h6>
                    ...
                    <div class="tf-container">
                        <div class="callt-to-action flex-two">
                            ...
                            <div class="callt-to-action-button">
                                <a href="archive-tour.php" class="get-call">Let,s get started</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-37 center">
                                    <span
                                        class="sub-title-heading text-main font-yes fs-28-46 wow fadeInUp animated">Featured
                                        Tour</span>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                <a href="tour-single.php" class="tour-listing-image">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>United States
                                                        USA</span>
                                                    <h3 class="title-tour-list"><a href="tour-single.php">6 nights From
                                                            Africa</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="cheackmark flex mb-70">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#">Safety first always</a></h5>
                                            ...
                                            <div class="cheackmark flex">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#">Adventure & Climbing</a></h5>
                                                    <p class="des wow fadeInUp animated">Welcome to our Print 128 web
                                                        company that offers a wide </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="cheackmark flex mb-70">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#">Low price & friendly</a></h5>
                                                    <p class="des wow fadeInUp animated">Welcome to our Print 128 web
                                                        company that offers a wide </p>
                                                </div>
                                            </div>
                                            <div class="cheackmark flex">
                                                ...
                                                <div class="content">
                                                    <h5 class="mb-15 wow fadeInUp animated"><a href="#">Trusted travel guide</a></h5>
                                                    <p class="des wow fadeInUp animated">Welcome to our Print 128 web
                                                        company that offers a wide </p>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="tf-widget-blog blog-style2">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <a href="blog.php" class="btn-read-more">Read More <i
...
<!-- Mirrored from themesflat.co/html/vitour/home4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 10:16:31 GMT -->
</html>